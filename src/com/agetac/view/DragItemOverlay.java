...
/**
 * Item pouvant être "Draggable" c'est à dire pouvant être bougé dynamiquement
 * sur la map
 * 
 * @author Christophe Coelo - 29001702
 * 
 */
public class DragItemOverlay extends ItemizedOverlay<OverlayItem> {
	...
	public DragItemOverlay(Drawable marker, ResourceProxy mResourceProxy,
