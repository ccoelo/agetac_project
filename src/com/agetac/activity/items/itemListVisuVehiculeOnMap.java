...
*/
public class itemListVisuVehiculeOnMap implements Serializable{
	 ...
	 */
	public itemListVisuVehiculeOnMap (int id, String nom, int nombreSurLieux, int nombrePartis, String Color) {
