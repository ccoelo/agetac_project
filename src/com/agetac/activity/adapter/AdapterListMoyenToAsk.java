...
*/
public class AdapterListMoyenToAsk extends ArrayAdapter<itemListDemandeMoyens> {
	 ...
	 */
	public AdapterListMoyenToAsk(Fragment f, int textViewResourceId, ArrayList<itemListDemandeMoyens> listItems) {
