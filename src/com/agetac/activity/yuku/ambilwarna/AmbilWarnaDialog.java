package com.agetac.activity.yuku.ambilwarna;
...
public class AmbilWarnaDialog {
	 ...
	 * @param color
	 *            current color
	 * @param onAmbilWarnaListener
	 *            an OnAmbilWarnaListener, allowing you to get back error or
	 */
	public AmbilWarnaDialog(final Context context, int color, OnAmbilWarnaListener onAmbilWarnaListener) {
